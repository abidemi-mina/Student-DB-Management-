...
export default function StudentFormPage() {
 ...
 async function saveStudent(e: React.FormEvent) {
  ...
  try {
    ...
    // Now studentAPI.createStudent() returns the Student data directly
    const student = await studentAPI.createStudent(formattedData);
    ...
    <div className="min-h-screen bg-zinc-100 p-4 md:p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900">Register New Student</h1>
            <p className="text-zinc-600">Fill in all required fields to register a student</p>
          </div>
          <button
            type="button"
